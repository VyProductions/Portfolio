...
inline std::ostream& dim(std::ostream& os);
inline std::ostream& underlined(std::ostream& os);
inline std::ostream& blink(std::ostream& os);
inline std::ostream& reverse(std::ostream& os);
inline std::ostream& hidden(std::ostream& os);
inline std::ostream& bold_off(std::ostream& os);
inline std::ostream& dim_off(std::ostream& os);
inline std::ostream& underlined_off(std::ostream& os);
inline std::ostream& blink_off(std::ostream& os);
inline std::ostream& reverse_off(std::ostream& os);
inline std::ostream& hidden_off(std::ostream& os);
...
inline std::ostream& lt_gray(std::ostream& os);
...
inline std::ostream& bg_lt_gray(std::ostream& os);
inline std::ostream& bg_default(std::ostream& os);
inline std::ostream& dk_gray(std::ostream& os);
...
inline std::ostream& bg_dk_gray(std::ostream& os);
inline std::ostream& bg_lt_red(std::ostream& os);
inline std::ostream& bg_lt_green(std::ostream& os);
inline std::ostream& bg_lt_yellow(std::ostream& os);
inline std::ostream& bg_lt_blue(std::ostream& os);
inline std::ostream& bg_lt_magenta(std::ostream& os);
inline std::ostream& bg_lt_cyan(std::ostream& os);
inline std::ostream& bg_white(std::ostream& os);

// definitions
inline std::ostream& set_attr(ansi::attr_t  attr, std::ostream& output) {
